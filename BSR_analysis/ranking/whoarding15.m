function [ output_args ] = whoarding15( ddate )
    ...
    query_template=    ['SELECT company_id, name, bbuy, bsell, bnet, bvolume/2/volume, volume, ratio '...
                        ...
                        '						FROM bstop15 '...
                        '						WHERE tnet > 0 AND date="%s" AND company_id IN (SELECT symbol FROM callwarrant_spots) '...
    ...
    title_s = sprintf('%s Top15主力量能買超排行', ddate);
